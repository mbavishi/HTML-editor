...
class TextFormatComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: TextFormatComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.9", type: TextFormatComponent, isStandalone: true, selector: "app-text-format-component", inputs: { content: "content" }, ngImport: i0, template: "<div class=\"btn-group\">\n    <button class=\"btn toolbar-button fs-12\" (click)=\"toggleBold()\" title=\"Bold\"><i class=\"fas fa-bold\"></i></button>\n    <button class=\"btn toolbar-button fs-12\" (click)=\"toggleItalic()\" title=\"Italic\"><i class=\"fas fa-italic\"></i></button>\n    <button class=\"btn toolbar-button fs-12\" (click)=\"toggleUnderLine()\" title=\"Underline\"><i class=\"fas fa-underline\"></i></button>\n    <button class=\"btn toolbar-button fs-12\" (click)=\"toggleStrike()\" title=\"Strike\"><i class=\"fas fa-strikethrough\"></i></button>\n</div>", styles: [""] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: TextFormatComponent, decorators: [{
            type: Component,
...
class HeadingComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: HeadingComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.9", type: HeadingComponent, isStandalone: true, selector: "app-heading-component", inputs: { content: "content" }, ngImport: i0, template: "<div class=\"dropdown\">\n    <button class=\"btn toolbar-button fs-12 dropdown-toggle\" type=\"button\" data-bs-toggle=\"dropdown\" title=\"Select Heading\">\n        <i class=\"fas fa-heading\"></i>\n    </button>\n    <ul class=\"dropdown-menu\">\n        <li><a class=\"dropdown-item\" (click)=\"setBlockHeading(null)\">Normal Text</a></li>\n        <li><a class=\"dropdown-item\" (click)=\"setBlockHeading(1)\"><span style=\"font-size: 1.6rem;\">Heading 1</span></a>\n        </li>\n        <li><a class=\"dropdown-item\" (click)=\"setBlockHeading(2)\"><span style=\"font-size: 1.3rem;\">Heading 2</span></a>\n        </li>\n        <li><a class=\"dropdown-item\" (click)=\"setBlockHeading(3)\"><span style=\"font-size: 1.1rem;\">Heading 3</span></a>\n        </li>\n        <li><a class=\"dropdown-item\" (click)=\"setBlockHeading(4)\"><span style=\"font-size: 1rem;\">Heading 4</span></a>\n        </li>\n    </ul>\n</div>", styles: [""] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: HeadingComponent, decorators: [{
            type: Component,
...
class SuperSubFormat {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: SuperSubFormat, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.9", type: SuperSubFormat, isStandalone: true, selector: "app-super-sub-format", inputs: { content: "content" }, ngImport: i0, template: "<div class=\"btn-group\">\n    <button class=\"btn toolbar-button fs-12\" (click)=\"toggleSuperscript()\" title=\"Superscript\"><i class=\"fas fa-superscript\"></i></button>\n    <button class=\"btn toolbar-button fs-12\" (click)=\"toggleSubscript()\" title=\"Subscript\"><i class=\"fas fa-subscript\"></i></button>\n</div>", styles: [""] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: SuperSubFormat, decorators: [{
            type: Component,
...
class UndoRedo {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: UndoRedo, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.9", type: UndoRedo, isStandalone: true, selector: "app-undo-redo", inputs: { content: "content" }, ngImport: i0, template: "<div class=\"btn-group\">\n    <button class=\"btn toolbar-button fs-12\" (click)=\"undoAction()\" title=\"Undo\"><i class=\"fas fa-undo\"></i></button>\n    <button class=\"btn toolbar-button fs-12\" (click)=\"redoAction()\" title=\"Redo\"><i class=\"fas fa-redo\"></i></button>\n</div>", styles: [""] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: UndoRedo, decorators: [{
            type: Component,
...
class Alignment {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: Alignment, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.9", type: Alignment, isStandalone: true, selector: "app-alignment", inputs: { content: "content" }, ngImport: i0, template: "<div class=\"btn-group border-end-1\">\n    <button class=\"btn toolbar-button fs-12\" (click)=\"setAlign('left')\" title=\"Align text left\"><i class=\"fas fa-align-left\"></i></button>\n    <button class=\"btn toolbar-button fs-12\" (click)=\"setAlign('center')\" title=\"Align text center\"><i class=\"fas fa-align-center\"></i></button>\n    <button class=\"btn toolbar-button fs-12\" (click)=\"setAlign('right')\" title=\"Align text right\"><i class=\"fas fa-align-right\"></i></button>\n    <button class=\"btn toolbar-button fs-12 border-end-1\" (click)=\"setAlign('justify')\" title=\"Align text justify\"><i class=\"fas fa-align-justify\"></i></button>\n</div>", styles: [""] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: Alignment, decorators: [{
            type: Component,
...
class ConfigService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: ConfigService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: ConfigService, providedIn: 'root' });
}
...
class ColorFormat {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: ColorFormat, deps: [{ token: ConfigService }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.9", type: ColorFormat, isStandalone: true, selector: "app-color-format", inputs: { content: "content" }, ngImport: i0, template: "<div class=\"d-flex\">\n    <div class=\"color-palette\">\n        <!-- Font color -->\n        <button class=\"btn toolbar-button fs-12\" type=\"button\" title=\"Text Color\" (click)=\"fontColorPicker.click()\">\n            <i class=\"fas fa-paint-brush\"></i>\n        </button>\n        <input #fontColorPicker type=\"color\" class=\"color-picker\" (change)=\"setFontColor($event)\">\n    </div>\n    <!-- Background color -->\n    <div class=\"color-palette\">\n        <button class=\"btn toolbar-button fs-12\" type=\"button\" title=\"Background Color\" (click)=\"bgColorPicker.click()\">\n            <i class=\"fas fa-fill-drip\"></i>\n        </button>\n        <input #bgColorPicker type=\"color\" class=\"color-picker\" (change)=\"setBackgroundColor($event)\">\n    </div>\n</div>", styles: [".color-palette{position:relative}.color-picker{opacity:0;position:absolute;left:5px;top:12px}\n"] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: ColorFormat, decorators: [{
            type: Component,
...
class ListFormat {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: ListFormat, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.9", type: ListFormat, isStandalone: true, selector: "app-list-format", inputs: { content: "content" }, ngImport: i0, template: "<div class=\"btn-group\">\n    <button class=\"btn toolbar-button fs-12\" (click)=\"toggleBulletList()\"\n        title=\"Insert unordered List\"><i class=\"fas fa-list-ul\"></i></button>\n    <button class=\"btn toolbar-button fs-12\" (click)=\"toggleOrderedList()\"\n        title=\"Insert ordered List\"><i class=\"fas fa-list-ol\"></i></button>\n</div>", styles: [""] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: ListFormat, decorators: [{
            type: Component,
...
class SourceCode {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: SourceCode, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.9", type: SourceCode, isStandalone: true, selector: "app-source-code", inputs: { html: "html" }, ngImport: i0, template: "<div class=\"btn-group me-2\">\n    <button class=\"btn toolbar-button fs-12\" (click)=\"toggleSourceCode()\" title=\"Superscript\"><i class=\"bi bi-code-slash\"></i></button>\n</div>", styles: [""] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: SourceCode, decorators: [{
            type: Component,
...
class FontSizeComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: FontSizeComponent, deps: [{ token: ConfigService }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.9", type: FontSizeComponent, isStandalone: true, selector: "app-font-size", inputs: { content: "content" }, ngImport: i0, template: "<div class=\"btn-group\">\n  <!-- Heading size -->\n  <div class=\"dropdown\">\n    <button class=\"btn toolbar-button fs-12 dropdown-toggle\" type=\"button\" data-bs-toggle=\"dropdown\"\n      title=\"Select Heading\">\n      <i class=\"fas fa-heading\"></i>\n    </button>\n    <ul class=\"dropdown-menu\">\n      <li *ngFor=\"let h of headings\">\n        <a class=\"dropdown-item\" (click)=\"setBlockHeading(h.level)\">\n          <span [style.fontSize]=\"h.size\">{{ h.label }}</span>\n        </a>\n      </li>\n    </ul>\n    <!-- Font Size -->\n    <button class=\"btn toolbar-button fs-12 dropdown-toggle\" type=\"button\" data-bs-toggle=\"dropdown\"\n      title=\"Select Font Size\">\n      <i class=\"fas fa-text-height\"></i>\n    </button>\n    <ul class=\"dropdown-menu font-size-menu\" style=\"max-height: 300px; overflow-y: auto; width: 60px;\">\n      <li *ngFor=\"let size of fontSizes\">\n        <a class=\"dropdown-item\" (click)=\"setFontSize(size)\">\n          <span>{{ size }}</span>\n        </a>\n      </li>\n    </ul>\n  </div>\n</div>", styles: [""], dependencies: [{ kind: "directive", type: NgFor, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: FontSizeComponent, decorators: [{
            type: Component,
...
class IndentOutdentComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: IndentOutdentComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.9", type: IndentOutdentComponent, isStandalone: true, selector: "app-indent-outdent", inputs: { content: "content" }, ngImport: i0, template: "<div class=\"btn-group\">\n    <button class=\"btn toolbar-button fs-12\" (click)=\"indent()\" title=\"Indent\"><i class=\"fas fa-indent\"></i></button>\n    <button class=\"btn toolbar-button fs-12\" (click)=\"outdent()\" title=\"Outdent\"><i class=\"fas fa-outdent\"></i></button>\n</div>", styles: [""] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: IndentOutdentComponent, decorators: [{
            type: Component,
...
class FontFamilyComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: FontFamilyComponent, deps: [{ token: ConfigService }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.9", type: FontFamilyComponent, isStandalone: true, selector: "app-font-family", inputs: { content: "content" }, ngImport: i0, template: "<div class=\"btn-group\">\n  <select class=\"form-select form-select-sm font-family-dropdown\" (change)=\"setFontFamily($event)\">\n    <!-- <option selected disabled>Font Family</option> -->\n    <option *ngFor=\"let font of fontFamilies\" [value]=\"font\">{{ font }}</option>\n  </select>\n</div>\n", styles: [""], dependencies: [{ kind: "directive", type: NgFor, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: FontFamilyComponent, decorators: [{
            type: Component,
...
class InventyvHtmlEditorComponent {
    editorHost;
    contentTemplate;
    contentTemplateChange = new EventEmitter();
    html;
    ngAfterViewInit() {
        setTimeout(() => {
            ...
            console.log('🔥 Initial Editor State:', state);
            this.html = new EditorView(this.editorHost.nativeElement, {
                ...
                dispatchTransaction: tr => {
                    ...
                    console.log('🔥 Editor content updated:', updatedHTML);
                }
            });
            // Load initial HTML
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: InventyvHtmlEditorComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.9", type: InventyvHtmlEditorComponent, isStandalone: true, selector: "lib-inventyv-html-editor", inputs: { contentTemplate: "contentTemplate" }, outputs: { contentTemplateChange: "contentTemplateChange" }, viewQueries: [{ propertyName: "editorHost", first: true, predicate: ["editorHost"], descendants: true }], ngImport: i0, template: "<!-- Toolbar -->\n<app-toolbar-component *ngIf=\"html\" [content]=\"html\" class=\"lib-html-editor-toolbar\"></app-toolbar-component>\n<!-- Editor Area -->\n<div #editorHost class=\"lib-html-editor-content\"></div>", styles: [".editor-container{background:#fff}.ProseMirror{outline:none;white-space:pre-wrap}.ProseMirror p{margin:0 0 1em}.ProseMirror table{border-collapse:collapse;width:100%}.ProseMirror table,.ProseMirror th,.ProseMirror td{border:1px solid #c9c9c9}.ProseMirror th,.ProseMirror td{padding:4px;text-align:left}.ProseMirror:focus-visible{outline:none!important;box-shadow:none!important}.tableWrapper{overflow-x:auto}th{font-weight:400}.color-grid{display:grid;grid-template-columns:repeat(8,24px);gap:4px}.dropdown-item:hover{background-color:#d6d6d6;color:#000}.toolbar-button:hover{background-color:#d6d6d6!important;color:#000!important}.toolbar-button{border:none!important;border-radius:0%!important;--bs-btn-padding-x: .6rem}.btn-group{border-radius:0%;border-right:1px solid #c9c9c9!important}.toolbar-button:disabled{border:none!important}.font-size-menu{min-width:50px!important}.font-family-dropdown{max-height:30px!important}.fs-6{font-size:12px!important}select.form-select{border:none!important;border-radius:0%!important;--bs-btn-padding-x: .6rem;font-size:12px!important}select.form-select option{padding:4px 8px;transition:background-color .2s ease,color .2s ease}select.form-select option:hover{background-color:#e0e0e0;color:#333}a:hover{color:#00008b;cursor:pointer}\n"], dependencies: [{ kind: "directive", type: NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "ngmodule", type: FormsModule }, { kind: "component", type: ToolbarComponent, selector: "app-toolbar-component", inputs: ["content"] }], encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: InventyvHtmlEditorComponent, decorators: [{
            type: Component,
            args: [{ selector: 'lib-inventyv-html-editor', standalone: true, imports: [NgFor, NgIf, FormsModule, ToolbarComponent], encapsulation: ViewEncapsulation.None, template: "<!-- Toolbar -->\n<app-toolbar-component *ngIf=\"html\" [content]=\"html\" class=\"lib-html-editor-toolbar\"></app-toolbar-component>\n<!-- Editor Area -->\n<div #editorHost class=\"lib-html-editor-content\"></div>", styles: [".editor-container{background:#fff}.ProseMirror{outline:none;white-space:pre-wrap}.ProseMirror p{margin:0 0 1em}.ProseMirror table{border-collapse:collapse;width:100%}.ProseMirror table,.ProseMirror th,.ProseMirror td{border:1px solid #c9c9c9}.ProseMirror th,.ProseMirror td{padding:4px;text-align:left}.ProseMirror:focus-visible{outline:none!important;box-shadow:none!important}.tableWrapper{overflow-x:auto}th{font-weight:400}.color-grid{display:grid;grid-template-columns:repeat(8,24px);gap:4px}.dropdown-item:hover{background-color:#d6d6d6;color:#000}.toolbar-button:hover{background-color:#d6d6d6!important;color:#000!important}.toolbar-button{border:none!important;border-radius:0%!important;--bs-btn-padding-x: .6rem}.btn-group{border-radius:0%;border-right:1px solid #c9c9c9!important}.toolbar-button:disabled{border:none!important}.font-size-menu{min-width:50px!important}.font-family-dropdown{max-height:30px!important}.fs-6{font-size:12px!important}select.form-select{border:none!important;border-radius:0%!important;--bs-btn-padding-x: .6rem;font-size:12px!important}select.form-select option{padding:4px 8px;transition:background-color .2s ease,color .2s ease}select.form-select option:hover{background-color:#e0e0e0;color:#333}a:hover{color:#00008b;cursor:pointer}\n"] }]
